...
class ApAnage:
    ...
    def __init__(self):
        ...
        self.url_main = r'https://www.anageimoveis.com.br/comprar/'
        self.url = r'https://www.anageimoveis.com.br/comprar/apartamento/joinville?tipo%5B0%5D=2&tipo%5B1%5D=1&tipo%' \
                   r'5B2%5D=18&tipo%5B3%5D=19&tipo%5B4%5D=20&tipo%5B5%5D=16&tipo%5B6%5D=21&tipo%5B7%5D=35&page='
    ...
    # Get Results from Anage website
    def get_aptos_anage(self):
        aptos = []
